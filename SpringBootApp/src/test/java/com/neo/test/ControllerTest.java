...
public class ControllerTest {
	...
	/**
	 * This methode is used to UserMasterTesting If response is success
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	...
	/**
	 * This methode is used to UserMasterTesting If response is Failed
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	...
	/**
	 * This methode is used to UserDetailsUpdate If response is Success
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	...
	/**
	 * This methode is used to UserDetailsUpdate If response is failed
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	...
	/**
	 * This methode is used to searchUser If response is Success
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	...
	/**
	 * This methode is used to sortingUserByDates If response is Success
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	 ...
	 */
	@Test
	public void sortingUsersIfSucces() throws Exception {
		Mockito.when(userService.sortingUsers()).thenReturn(list);
		assertEquals(list, regController.sortingUsers());
	}
	
	/**
	 * This methode is used to sortingUserByDates If response is Failed
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	 ...
	 */
	@Test
	public void sortingUsersIfFailed() throws Exception {
		list=new ArrayList<UserEntity>();
		Mockito.when(userService.sortingUsers()).thenReturn(list);
		assertEquals(list, regController.sortingUsers());
	}
	...
	/**
	 * This methode is used to deleteUsers If response is Success
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
	...
	/**
	 * This methode is used to deleteUsers If response is failed
	 * 
	 * @param entity
	 * @param mrId
	 * @return ResponseEntity<String> message
...
/*	@Test
	public void deleteUserTestIfFailed() throws Exception {
		failResMsg.setMessage(AppConstants.FAILDELETEMESSAGE);
		failResMsg.setStatusCode(204);
		Mockito.when(userService.deleteUserDetailsById(null)).thenReturn(failResMsg);
		System.out.println(new ResponseEntity<ResponseEntityMessage>(failResMsg, HttpStatus.NO_CONTENT)+" ==="+regController.deleteUserById(null));
		assertEquals(new ResponseEntity<ResponseEntityMessage>(failResMsg, HttpStatus.NO_CONTENT),
				regController.deleteUserById(null));
